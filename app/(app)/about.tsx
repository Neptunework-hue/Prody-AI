...
const VERSIONS = [
  {
    ...
    changes: [
      'Password reset via Expo tunnel deep links + 6-digit recovery code',
      'Sign-up email confirmation opens the app through tunnel URLs',
      'Forgot-password flow checks auth.users and profiles before sending email',
      'Auth deep-link handler for recovery and confirmation sessions',
      'Root layout: theme providers, GestureHandlerRootView, and navigation stack',
      'Login success state after email confirmation',
      'Improved swipe navigation between main tab screens',
    ],
  },
  {
    version: 'v6.0',
  ...
  },
  {
    ...
    changes: [
      'Swipe navigation between dashboard, calendar, tasks, habits, and focus',
      'Bottom navigation and drawer sidebar polish',
      'Statistics and profile screen refinements',
      'Habit quest cards and streak helpers',
      'Task folders and draggable task ordering',
    ],
  },
  {
    version: 'v4.0',
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroVersion}>Version 7.0 · May 2026</Text>
          <Text style={styles.heroDesc}>
            A gamified productivity companion — tasks, focus, habits, and an AI oracle — with secure auth, tunnel-friendly email flows, and a unified quest-themed workspace.
          </Text>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>ProdyAI v7 · Graduation Project 2026</Text>
          <Text style={styles.footerAccent}>Built with React Native + Expo SDK 54</Text>
