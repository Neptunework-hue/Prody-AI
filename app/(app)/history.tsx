  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      >
        ...
        {loading ? (
          <Text style={[styles.loading, { color: LT.parchmentMuted }]}>Loading...</Text>
        ) : tasks.length === 0 ? (
          <Text style={[styles.empty, { color: LT.parchmentMuted }]}>No completed quests yet. Trophy shelf will fill as you finish tasks.</Text>
        ) : (
          tasks.map(task => (
            <Card
              key={task.id}
            ...
            >
              <Card.Content>
                ...
                <Text style={[styles.taskDesc, { color: LT.parchmentMuted }]}>{task.description}</Text>
